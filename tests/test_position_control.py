...
def test_internals(get_1d_position_controller):
    ...
    for dof in range(4):
        assert position_controller._q_trajectories[dof][0] == 10.0
        assert position_controller._q_trajectories[dof][-1] == 20.0
        assert position_controller._dq_trajectories[dof][0] == 5.0
        assert position_controller._dq_trajectories[dof][-11] == 5.0
        assert position_controller._dq_trajectories[dof][-1] == 0.0
        assert position_controller._dq_trajectories[dof][-10] == 0.0
