...
class Logger:
    ...
    def __init__(self, segment_id, file_path, frequency=500.0):
        ...
        if not os.access(folder, os.W_OK):
            raise FileNotFoundError(
                "The directory {} does not seem to be writable".format(folder)
            )
    ...
    def start(self):
        ...
        try:
            ...
            raise Exception(
                "Failed to create an o80 frontend"
...
class FileManager:
    ...
    def __init__(self, root_folder="/tmp/", prefix="o80_pam_observations_"):
    ...
    def list_files(self):
        ...
        files = [
            f
            for f in os.listdir(self._root_folder)
            if os.path.isfile(os.path.join(self._root_folder, f))
        ]
        files = [
            os.path.join(self._root_folder, f)
            for f in files
    ...
    def next(self):
        ...
        return os.path.join(
            self._root_folder,
            self._prefix + str(newest_files.num + 1) + "_" + date_time,
        )
